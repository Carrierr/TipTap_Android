    ...
    fun call() {
        try {
            ...
            if (authTypes.size == 1) {
                ...
                val methodOnClickLoginButton = LoginButton::class.java.getDeclaredMethod("onClickLoginButton", LoginActivity::class.java)
                methodOnClickLoginButton.isAccessible = true
